<div class="services__order">
    ...
    <form wire:submit.prevent="submit" class="services__order-form">
        ...
        <div class="services__order-item">
            <label for="location" class="services__order-label">{{ __('form.location') }}</label>
        ...
        <div class="services__order-item">
            <label for="full_name" class="services__order-label">{{ __('form.name_and_surname') }}</label>
        ...
        <div class="services__order-item">
            <label for="phone" class="services__order-label">{{ __('form.phone') }}</label>
        ...
        <div class="services__order-item">
            <button class="services__order-button button button--primary">{{ __('form.send') }}</button>
        </div>
